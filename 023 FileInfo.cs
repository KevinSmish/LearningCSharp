...
// директорию TESTDIR и поместить в нее некоторое количество файлов с расширением .cs
    ...
    class Program
    {
        static void Main()
        {
            ...
            if (directory.Exists)
            {
                ...
                // Сколько файлов с расширением .cs в данной директории.
                Console.WriteLine("Найдено {0} *.cs файлов\n", files.Length);
